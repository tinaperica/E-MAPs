%CJM: these lines are the annotations chris made to explain each function call
...
% THIS IS THE VERSION I (HANNES) USED FOR SCORING RNAPII, FEB 2011.
% Filter cutoffs here are based on 95 percentile, 70%ile, 30%ile and 5%ile
% in final set prior to averaging.


%CJM: these values are the quantiles for the unaveraged data
...
if ismember('rowMut',fn) & ismember('colMut',fn) %CJM: just confirms that rowMut and colMut are attributes of the matrix object
    for i=1:r
...
%CJM: if needed, compute the spline function describing second measurements as a function of first
if nargin<2
