...
# run a task per cluster - there are 42 clusters/complexes for the large ppi complexes approach
cluster_number <- as.numeric( Sys.getenv( "SGE_TASK_ID" ))
#cluster_number <- 1
#### preprocessed correlations
load( paste0( "preprocessed_correlations/", "2017-12-25_", cluster_number, "_corr_lst.RData" ) )
