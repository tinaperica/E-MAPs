### this script does all the clusters but for a small subset (133) of pairs per task (times 63 clusters)
## clusters are actually Wodak complexes with 6 or more subunits
...
#### the pairs below include only pairs made of all the mutants and only the yeast genes from the ubermap that have significant correlations 
#### with at least one of the mutants (these pairs are determined by the getMutantsAndUbergenesToCorrelate.R)
...
# 
# query1 <- "A180T"
# query2 <- "CTER3XFLAG WT"
# q1 <- "A180T"
# q2 <- "CTER3XFLAG WT"
# cluster <- "commitment complex"
