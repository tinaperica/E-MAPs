...
corr_lst <- list()  ## final, contains coor per cluster as well as vectors of mut, partner, pairs, clustering method info
correlations <- list() ### contains the correlations per cluster
all_genes <- vector()
dir_name <- "clustered_correlations/test_subset/"  #### run on guybrush
